...
* FIXME: Items falling off loot factor today say 'less than 1 minute from today'
* FIXME: loot_factor_cutoff needs to make the first character capitalized ('About one month from today')
* FIXME: Achievements page isn't setting page_title properly.
