...
ActiveRecord::Schema.define(:version => 20090404033151) do
  ...
  create_table "mgdkp_items", :primary_key => "item_id", :force => true do |t|
    t.string  "item_name"
    t.string  "item_buyer",       :limit => 50
    t.integer "raid_id",                        :default => 0,     :null => false
    t.float   "item_value",       :limit => 11, :default => 0.0,   :null => false
    t.integer "item_date",                      :default => 0,     :null => false
    t.string  "item_added_by",    :limit => 30, :default => "",    :null => false
    t.string  "item_updated_by",  :limit => 30
    t.string  "item_group_key",   :limit => 32
    t.boolean "item_situational",               :default => false, :null => false
    t.boolean "item_bis",                       :default => false, :null => false
  end

  create_table "mgdkp_member_ranks", :primary_key => "rank_id", :force => true do |t|
    t.string  "rank_name",   :limit => 50, :default => "",    :null => false
    t.boolean "rank_hide",                 :default => false, :null => false
    t.string  "rank_prefix", :limit => 75, :default => "",    :null => false
    t.string  "rank_suffix", :limit => 75, :default => "",    :null => false
  end

  add_index "mgdkp_member_ranks", ["rank_id"], :name => "rank_id", :unique => true

  create_table "mgdkp_members", :primary_key => "member_id", :force => true do |t|
    t.string  "member_name",       :limit => 30, :default => "",   :null => false
    t.float   "member_earned",     :limit => 11, :default => 0.0,  :null => false
    t.float   "member_spent",      :limit => 11, :default => 0.0,  :null => false
    t.float   "member_adjustment", :limit => 11, :default => 0.0,  :null => false
    t.boolean "member_status",                   :default => true, :null => false
    t.integer "member_firstraid",                :default => 0,    :null => false
    t.integer "member_lastraid",                 :default => 0,    :null => false
    t.integer "member_raidcount",                :default => 0,    :null => false
    t.integer "member_level",      :limit => 1,  :default => 70,   :null => false
    t.integer "member_race_id",    :limit => 2,  :default => 0,    :null => false
    t.integer "member_class_id",   :limit => 2,  :default => 0,    :null => false
    t.integer "member_rank_id",    :limit => 2,  :default => 0,    :null => false
    t.float   "member_lf",         :limit => 11, :default => 0.0,  :null => false
    t.float   "member_slf",        :limit => 11, :default => 0.0,  :null => false
    t.float   "member_bis",        :limit => 11, :default => 0.0,  :null => false
    t.float   "member_30",         :limit => 3,  :default => 0.0,  :null => false
    t.float   "member_90",         :limit => 3,  :default => 0.0,  :null => false
    t.float   "member_lt",         :limit => 3,  :default => 0.0,  :null => false
  end

  add_index "mgdkp_members", ["member_name"], :name => "member_name", :unique => true

  create_table "mgdkp_raid_attendees", :id => false, :force => true do |t|
    t.integer "raid_id",         :limit => 3,  :default => 0,   :null => false
    t.string  "member_name",     :limit => 30, :default => "",  :null => false
    t.float   "raid_attendance", :limit => 3,  :default => 1.0, :null => false
  end

  add_index "mgdkp_raid_attendees", ["raid_id", "member_name"], :name => "raid_member", :unique => true

  create_table "mgdkp_raids", :primary_key => "raid_id", :force => true do |t|
    t.string  "raid_name"
    t.integer "raid_date",                     :default => 0,   :null => false
    t.string  "raid_note"
    t.float   "raid_value",      :limit => 11, :default => 0.0, :null => false
    t.string  "raid_added_by",   :limit => 30, :default => "",  :null => false
    t.string  "raid_updated_by", :limit => 30
    t.integer "raid_thread",                   :default => 0,   :null => false
  end

  create_table "mgdkp_wishlist", :primary_key => "wl_id", :force => true do |t|
    t.string "wl_member", :limit => 30, :default => "",       :null => false
    t.string "wl_item",                 :default => "",       :null => false
    t.string "wl_type",   :limit => 20, :default => "normal", :null => false
    t.string "wl_note",                 :default => "",       :null => false
  end
