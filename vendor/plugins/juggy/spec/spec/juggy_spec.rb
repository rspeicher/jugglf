...
describe Juggy do
  ...
  describe "#parse_loots" do
    ...
    it "should figure out price based on item stats" do
      ...
      Item.stub!(:find_or_initialize_by_name).and_return(Factory(:item))
    ...
    describe "multiple items of the same name" do
      it "should create a non-existent item if given the ID" do
        ...
        loots = Juggy.parse_loots("Tsigo - [#{new_item.name}]|#{new_item.id}")
    ...
    describe "loot details" do
      ...
      it "should use the id if provided" do
        glaive_main = Item.make(:name => 'Warglaive of Azzinoth', :id => 32837)
        glaive_off  = Item.make(:name => 'Warglaive of Azzinoth', :id => 32838)
